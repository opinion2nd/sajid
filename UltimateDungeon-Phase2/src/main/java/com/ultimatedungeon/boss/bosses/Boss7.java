...
/** Boss 7 — unique boss implementation. Name, abilities, and arena defined in Milestone 4. */
public final class Boss7 implements IBoss {
    @Override @NotNull public String getBossId() { return "boss_7"; }
    @Override @NotNull public String getDisplayName() { return "Boss 7"; }
