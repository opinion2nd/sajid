...
/** Boss 4 — unique boss implementation. Name, abilities, and arena defined in Milestone 4. */
public final class Boss4 implements IBoss {
    @Override @NotNull public String getBossId() { return "boss_4"; }
    @Override @NotNull public String getDisplayName() { return "Boss 4"; }
