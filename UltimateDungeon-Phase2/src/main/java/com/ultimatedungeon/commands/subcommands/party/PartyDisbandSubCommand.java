...
/** /party disband — implemented in Milestone 5. */
public final class PartyDisbandSubCommand implements ISubCommand {
    @Override @NotNull public String getName() { return "disband"; }
