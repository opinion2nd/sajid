...
/** /party create — implemented in Milestone 5. */
public final class PartyCreateSubCommand implements ISubCommand {
    @Override @NotNull public String getName() { return "create"; }
