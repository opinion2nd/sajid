...
/** RareMonster1 — rare dungeon monster with unique drops. Milestone 4. */
public final class RareMonster1 implements IMonster {
    @Override @NotNull public String getMonsterId() { return "rare_monster_1"; }
    @Override @NotNull public String getDisplayName() { return "Rare Monster 1"; }
