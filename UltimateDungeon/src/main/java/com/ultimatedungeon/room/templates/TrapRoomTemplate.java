...
/**
 * Room template: TrapRoomTemplate (TRAP).
 *
 * <p>Width x Depth: 13 x 15, height: 7. Accent-block pillars are
 * placed for visual identity; full type-specific decoration is wired in
 * the block-placement milestone.</p>
 */
public final class TrapRoomTemplate extends AbstractRoomTemplate {

    public TrapRoomTemplate() {
