...
/**
 * Room template: CombatRoomTemplate (COMBAT).
 *
 * <p>Width x Depth: 17 x 17, height: 7. Accent-block pillars are
 * placed for visual identity; full type-specific decoration is wired in
 * the block-placement milestone.</p>
 */
public final class CombatRoomTemplate extends AbstractRoomTemplate {

    public CombatRoomTemplate() {
        super("combat", RoomType.COMBAT, 40);
    }

    @Override public int getWidth() { return 17; }
    @Override public int getDepth() { return 17; }
