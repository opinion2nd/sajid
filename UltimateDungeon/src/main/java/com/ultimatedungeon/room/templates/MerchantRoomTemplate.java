...
/**
 * Room template: MerchantRoomTemplate (MERCHANT).
 *
 ...
 */
public final class MerchantRoomTemplate extends AbstractRoomTemplate {

    public MerchantRoomTemplate() {
        super("merchant", RoomType.MERCHANT, 5);
    }
