...
/**
 * Room template: SecretRoomTemplate (SECRET).
 *
 * <p>Width x Depth: 9 x 9, height: 7. Accent-block pillars are
 * placed for visual identity; full type-specific decoration is wired in
 * the block-placement milestone.</p>
 */
public final class SecretRoomTemplate extends AbstractRoomTemplate {

    public SecretRoomTemplate() {
        super("secret", RoomType.SECRET, 5);
    }

    @Override public int getWidth() { return 9; }
    @Override public int getDepth() { return 9; }
