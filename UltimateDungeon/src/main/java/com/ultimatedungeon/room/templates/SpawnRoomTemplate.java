...
/**
 * Room template: SpawnRoomTemplate (SPAWN).
 *
 ...
 */
public final class SpawnRoomTemplate extends AbstractRoomTemplate {

    public SpawnRoomTemplate() {
        super("spawn", RoomType.SPAWN, 1);
    }
