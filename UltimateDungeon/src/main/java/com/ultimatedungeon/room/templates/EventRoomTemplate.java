...
/**
 * Room template: EventRoomTemplate (EVENT).
 *
 ...
 */
public final class EventRoomTemplate extends AbstractRoomTemplate {

    public EventRoomTemplate() {
        super("event", RoomType.EVENT, 8);
    }
