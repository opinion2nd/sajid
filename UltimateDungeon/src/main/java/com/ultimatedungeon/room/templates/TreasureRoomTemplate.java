...
/**
 * Room template: TreasureRoomTemplate (TREASURE).
 *
 * <p>Width x Depth: 11 x 11, height: 7. Accent-block pillars are
 * placed for visual identity; full type-specific decoration is wired in
 * the block-placement milestone.</p>
 */
public final class TreasureRoomTemplate extends AbstractRoomTemplate {

    public TreasureRoomTemplate() {
        super("treasure", RoomType.TREASURE, 10);
    }
