...
/**
 * Room template: BossRoomTemplate (BOSS).
 *
 * <p>Width x Depth: 25 x 25, height: 7. Accent-block pillars are
 * placed for visual identity; full type-specific decoration is wired in
 * the block-placement milestone.</p>
 */
public final class BossRoomTemplate extends AbstractRoomTemplate {

    public BossRoomTemplate() {
