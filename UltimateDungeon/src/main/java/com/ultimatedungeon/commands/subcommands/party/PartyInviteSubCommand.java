...
/** /party invite — implemented in Milestone 5. */
public final class PartyInviteSubCommand implements ISubCommand {
    @Override @NotNull public String getName() { return "invite"; }
