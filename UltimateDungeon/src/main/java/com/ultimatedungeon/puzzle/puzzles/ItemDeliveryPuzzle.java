...
/** ItemDeliveryPuzzle — puzzle implementation. Milestone 4. */
public final class ItemDeliveryPuzzle implements IPuzzle {
    @Override @NotNull public String getPuzzleId() { return "ItemDeliveryPuzzle"; }
