...
/** Boss 6 — unique boss implementation. Name, abilities, and arena defined in Milestone 4. */
public final class Boss6 implements IBoss {
    @Override @NotNull public String getBossId() { return "boss_6"; }
    @Override @NotNull public String getDisplayName() { return "Boss 6"; }
