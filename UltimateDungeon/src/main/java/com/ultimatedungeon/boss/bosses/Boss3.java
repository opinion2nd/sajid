...
/** Boss 3 — unique boss implementation. Name, abilities, and arena defined in Milestone 4. */
public final class Boss3 implements IBoss {
    @Override @NotNull public String getBossId() { return "boss_3"; }
    @Override @NotNull public String getDisplayName() { return "Boss 3"; }
