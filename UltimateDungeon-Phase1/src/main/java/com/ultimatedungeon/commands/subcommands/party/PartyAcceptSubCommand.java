...
/** /party accept — implemented in Milestone 5. */
public final class PartyAcceptSubCommand implements ISubCommand {
    @Override @NotNull public String getName() { return "accept"; }
