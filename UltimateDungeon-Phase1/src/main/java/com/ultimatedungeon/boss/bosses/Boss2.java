...
/** Boss 2 — unique boss implementation. Name, abilities, and arena defined in Milestone 4. */
public final class Boss2 implements IBoss {
    @Override @NotNull public String getBossId() { return "boss_2"; }
    @Override @NotNull public String getDisplayName() { return "Boss 2"; }
