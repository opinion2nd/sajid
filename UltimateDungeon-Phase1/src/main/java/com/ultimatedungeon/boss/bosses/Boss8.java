...
/** Boss 8 — unique boss implementation. Name, abilities, and arena defined in Milestone 4. */
public final class Boss8 implements IBoss {
    @Override @NotNull public String getBossId() { return "boss_8"; }
    @Override @NotNull public String getDisplayName() { return "Boss 8"; }
